...
Solar_system=orbit(G=G,Ke=0,frames=False,dt=0.05,RCM=RM,traj_show_save='save',capture=False,is_adaptive=False,bodies=Body_list,draw=False) #dt=1 is 1 day. If is_adaptive=True, dt is ignored and is
                                                                                                                                          #                calculated in each iteration  
Solar_system.run(timelimit=24,clear_cache=False)  #If timelimit is stated, the program will finish after the stated time (in years).
